          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 max-w-7xl mx-auto font-body text-sm relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <a className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/80 hover:bg-[#0077b5] hover:text-white hover:shadow-[0_0_20px_rgba(0,119,181,0.6)] transition-all border border-white/10" 
